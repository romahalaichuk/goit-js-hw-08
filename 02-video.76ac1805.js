 ...
 */function(e,t,r){var o,i,a,u,c,l,s=0,f=!1,d=!1,h=!0;if("function"!=typeof e)throw TypeError(n);function w(t){var n=o,r=i;return o=i=void 0,s=t,u=e.apply(r,n)}function b(e){var n=e-l,r=e-s;// Either this is the first call, activity has stopped and we're at the
// trailing edge, the system time has gone backwards and we're treating
// it as the trailing edge, or we've hit the `maxWait` limit.
return void 0===l||n>=t||n<0||d&&r>=a}function k(){var e,n,r,o=y();if(b(o))return E(o);// Restart the timer.
...
(c=void 0,h&&o)?w(e):(o=i=void 0,u))}function x(){var e,n=y(),r=b(n);if(o=arguments,i=this,l=n,r){if(void 0===c)return(// Reset any `maxWait` timer.
s=e=l,// Start the timer for the trailing edge.
c=setTimeout(k,t),f?w(e):u);if(d)return(// Handle invocations in a tight loop.
c=setTimeout(k,t),w(l))}return void 0===c&&(c=setTimeout(k,t)),u}return t=g(t)||0,m(r)&&(f=!!r.leading,a=(d="maxWait"in r)?p(g(r.maxWait)||0,t):a,h="trailing"in r?!!r.trailing:h),x.cancel=function(){void 0!==c&&clearTimeout(c),s=0,o=l=i=c=void 0},x.flush=function(){return void 0===c?u:E(y())},x}(e,t,{leading:o,maxWait:t,trailing:i})}});/**
 ...
 */var Y={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},$=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&b(e,t)}(a,e);var t,n,r,o,i=(t=k(),function(){var e,n=w(a);if(t){var r=w(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return T(e)}(this,e)});/**
...
B.set(this,a),Q.set(this.element,this),"IFRAME"===this.element.nodeName&&W(this,"ping"),J.isEnabled){var u=function(){return J.exit()};this.fullscreenchangeHandler=function(){J.isFullscreen?I(r,"event:exitFullscreen",u):V(r,"event:exitFullscreen",u),// eslint-disable-next-line
